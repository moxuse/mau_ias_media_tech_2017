...
この講義では、Processingというプログラミングによってコンピュータグラフィックを行うためのソフトウエアを使って、簡単な図形から初め、コンピューターで映像表現を行うための基礎的な技術と考え方を学びます。
...
Mike Bostockはアメリカのコンピューターサイエンティスト。今日のデータヴィジュアライゼーションの流れを作った人の一人。後ほど紹介する d3.js というJavaScriptのライブラリーのメイン開発者。2015年にNew York Timesに移り報道記事をデータとそれをわかりやすくヴィジュアライズする新しい報道手法(データジャーナリズムと呼ばれる)を実践した。
...
ここに挙げた例は全体としてはわずかですので、是非文献に当たって歴史を掘り下げて見て欲しいです。
...
Mr.Doob氏がメインで開発された3D描画のためのJavaScriptライブラリー。今では最も人気のWebGLのためのライブラリーとなった。
